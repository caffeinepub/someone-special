...
export class Backend implements backendInterface {
    ...
    async deleteHeartNote(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteHeartNote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editHeartNote(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editHeartNote(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllHeartNotes(): Promise<Array<HeartNote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllHeartNotes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHeartNote(arg0: string): Promise<HeartNote> {
        if (this.processError) {
            try {
                const result = await this.actor.getHeartNote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPersonalGreetingMessage(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getPersonalGreetingMessage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePersonalGreetingMessage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
